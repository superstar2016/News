...
const float NDInitialProgressValue = 0.1f;
const float NDInteractiveProgressValue = 0.5f;
const float NDFinalProgressValue = 0.9f;

@implementation NDWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < NDInitialProgressValue) {
        [self setProgress:NDInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? NDFinalProgressValue : NDInteractiveProgressValue;
